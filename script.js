// script_full.js - نظام إدارة عقود الاعتماد الأكاديمي
...
function showContractDetail(contract) {
    ...
    detail.innerHTML = `
        ...
        <div class="detail-grid">
            ...
            <div class="detail-item">
                <span class="detail-label">اتباع شروط استلام الوثائق</span>
                <span class="detail-value">${contract.docsReceivedStatus}</span>
            </div>
